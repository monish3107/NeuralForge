...
import { faq } from "../components/constants/index.jsx";
import FaqItems from "../components/constants/FaqItems.jsx";
            ...
            <Element name="faq" className="relative">
                <div className="container relative z-2 py-28">
                    <div>
                        ...
                        <p className="body-1 max-lg:max-w-sm">You got questions, we got answers</p>
                    </div>
