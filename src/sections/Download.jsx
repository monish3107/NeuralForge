...
import {links, logos} from "../components/constants/index.jsx";
                ...
                <div className="container">
                    <div className="flex items-center">
                        <div className="relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100">
                            ...
                            <p className="body-1 mb-10 max-w-md">Try it now for free on iOS, Andrioid, or Web.</p>
                        ...
                        <div className="mb-10 max-md:hidden">
                            <div className="download_preview-before download_preview-after rounded-40 relative w-[955px] border-2 border-s5 p-6">
                                <div className="relative rounded-3xl bg-s1 px-6 pb-6 pt-14">
                                    ...
                                    <img src="/images/screen.jpg" width={855} height={655} alt="screen" className="rounded-xl pointer-events-none"/>
                                </div>
                            </div>
                        </div>
                    </div>
