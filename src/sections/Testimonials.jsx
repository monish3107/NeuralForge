import { testimonials } from "/src/components/constants/index.jsx";
import TestimonialItem from "/src/sections/TestimonialItem.jsx";
    ...
    return (
        <section className="relative z-2 py-24 md:py-28 lg:py-40">
            <div className="container block lg:flex">
                <div className="testimonials_head-res relative z-2 mr-20 flex-30">
